...
implement battleship game in client-server architecture, using Python, TCP and TLS.
...
It will install two commands: `battleshipd` for server, and `battleship` for client.
